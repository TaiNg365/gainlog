    ...
    <div className="app">
      ...
      <div className="hdr">
        <div className="htop">
          ...
          <div className="hbtns">
            <button className="icb" style={{position:"relative"}} onClick={()=>{setGlasses(g=>Math.min(g+1,8));showToast("Water logged!");}}>
              💧
              <span style={{position:"absolute",top:-2,right:-2,background:glasses>=8?"#c8f135":"#4cc9f0",color:"#0a0a0f",borderRadius:"50%",width:14,height:14,fontSize:8,fontWeight:700,display:"flex",alignItems:"center",justifyContent:"center",lineHeight:1}}>{glasses}</span>
            </button>
