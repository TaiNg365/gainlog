        ...
        {tab==="workout" && (
          <>
            <div className="aib">
              ...
              {aiSugL && <Ldots/>}
              {aiSug && <div className="aitxt">{(aiSug||"").split("\n").map((l,i)=><span key={i}>{l}<br/></span>)}</div>}
                ...
                <div className="cal-summary">
                  ...
                  {aiCalEst && (
                    <div style={{background:"#111118",borderRadius:10,padding:"13px",marginTop:9,border:"1px solid #1c1c2c"}}>
                      ...
                      <div style={{fontSize:13,color:"#e8e8f0",lineHeight:1.8}}>{(aiCalEst||"").split("\n").map((line,i)=><span key={i}>{line}<br/></span>)}</div>
              ...
              <>
                ...
                {cardioLogs.length === 0 ? (
                  ...
                  <div key={l.id} className="cardio-item">
                    <div style={{fontSize:10,color:C.mut}}>{l.date}</div>
            ...
            {savedPlans.length > 0 && <>
              ...
              {savedPlans.map((plan,pi)=>(
                <div key={plan.id} className="card" style={{marginBottom:9}}>
                  ...
                  {plan.rawText ? (
                    <div style={{fontSize:13,color:C.sub,lineHeight:1.7,whiteSpace:"pre-wrap"}} dangerouslySetInnerHTML={{__html:(plan.rawText||"").split("\n").join("<br/>")}}/>  
                  ) : (
          ...
          <>
            ...
            {editPlanData.rawText ? (
              <div className="card">
                ...
                <div style={{fontSize:13,color:C.sub,lineHeight:1.7,whiteSpace:"pre-wrap",marginBottom:9}} dangerouslySetInnerHTML={{__html:(editPlanData.rawText||"").split("\n").join("<br/>")}}/>
