...
const AI_PROVIDERS = {
  gemini: {
    name: "Google Gemini",
    icon: "🟢",
    models: ["gemini-2.5-flash-preview-04-17", "gemini-2.5-pro-preview-03-25", "gemini-1.5-flash", "gemini-1.5-flash-8b"],
  ...
  const detectMachine = async (imageBase64) => {
    ...
    try {
      ...
      if (providerToUse === "gemini" && keyToUse) {
        const r = await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-04-17:generateContent?key=" + keyToUse, {
          method:"POST", headers:{"Content-Type":"application/json"},
