...
export default function App() {
  ...
  const logWorkout = () => {
    ...
    setMachine(""); setMachSearch(""); setNewMach(""); setWNotes(""); setIsSuper(false); setSuperWith("");
            ...
            <div className="card">
              ...
              {isSuper && (
                <div style={{background:"#111118",borderRadius:12,padding:14,border:"1px solid #4cc9f040",marginTop:14}}>
                  ...
                  <select className="inp" style={{borderColor:"#4cc9f040",marginBottom:12}} value={superWith} onChange={e=>setSuperWith(e.target.value)}>
            ...
            {cardioTab==="log" && (
              <div className="card">
                ...
                <button className="btn bacc bfull" onClick={()=>{
                  ...
                  const entry = {id:uid(), date:today(), machine:cardioMachine, duration:Number(cardioDuration), calDisplay:Number(cardioCalDisplay)||0, notes:cardioNotes, type:"cardio"};
