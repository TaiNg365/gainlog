        ...
        {tab==="workout" && (
          <>
            <div className="aib">
              ...
              {aiSugL && <Ldots/>}
              {aiSug && <div className="aitxt" dangerouslySetInnerHTML={{__html:(aiSug||"").split("\n").join("<br/>").split("**").reduce((acc,v,i)=>acc+(i%2===1?"<b>"+v+"</b>":v),"")}}/>}
