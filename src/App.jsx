...
.navitem{display:flex;align-items:center;gap:14px;padding:13px 20px;cursor:pointer;border:none;background:transparent;width:100%;text-align:left;transition:background .15s;}
...
.navicon{font-size:22px;width:28px;text-align:center;flex-shrink:0;}
.navlbl{font-family:'DM Sans',sans-serif;font-size:15px;font-weight:600;color:#e8e8f0;}
.navitem.active .navlbl{color:#c8f135;}
.navsub{font-size:10px;color:#6a6a8a;margin-top:1px;}
        ...
        <>
          ...
          <div className="sidenav">
            <div className="sidenav-logo">
              <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:28,letterSpacing:3,color:"#c8f135",lineHeight:1}}>GAINLOG</div>
              <div style={{fontSize:10,color:"#6a6a8a",letterSpacing:1,textTransform:"uppercase",marginTop:2}}>
            ...
            <div className="sidenav-footer">
              <div style={{fontSize:10,color:"#3a3a5a",marginBottom:4}}>
