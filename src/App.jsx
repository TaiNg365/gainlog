...
.bnav{position:fixed;bottom:0;left:50%;transform:translateX(-50%);width:100%;max-width:430px;background:#111118;border-top:1px solid #1c1c2c;display:flex;overflow-x:auto;z-index:50;}
.bnav::-webkit-scrollbar{display:none;}
.bnt{flex-shrink:0;min-width:52px;padding:7px 4px 11px;border:none;background:transparent;color:#3a3a5a;font-size:17px;cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:2px;}
.bnt.on{color:#c8f135;}
