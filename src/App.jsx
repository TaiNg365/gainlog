...
const APP_CSS = `*{box-sizing:border-box;margin:0;padding:0;} body{background:#090910;color:#e8e8f0;font-family:'DM Sans',sans-serif;min-height:100vh;} .app{max-width:430px;margin:0 auto;min-height:100vh;display:flex;flex-direction:column;} .hdr{padding:12px 18px 12px;background:#090910;position:sticky;top:0;z-index:50;border-bottom:1px solid #1c1c2c;} .htop{display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;} .logo{font-family:'Bebas Neue',sans-serif;font-size:24px;letter-spacing:2px;color:#c8f135;line-height:1;} .lsub{font-size:9px;color:#6a6a8a;letter-spacing:1px;text-transform:uppercase;} .hbtns{display:flex;gap:7px;} .icb{background:#1c1c2c;border:none;color:#e8e8f0;border-radius:50%;width:34px;height:34px;font-size:15px;cursor:pointer;display:flex;align-items:center;justify-content:center;} .icb:active{opacity:.7;} .tabs{display:flex;overflow-x:auto;padding-bottom:0;} .tabs::-webkit-scrollbar{display:none;} .tab{flex-shrink:0;padding:7px 11px;border:none;background:transparent;color:#6a6a8a;font-family:'DM Sans',sans-serif;font-size:10px;font-weight:600;cursor:pointer;border-bottom:2px solid transparent;white-space:nowrap;} .tab.on{color:#c8f135;border-bottom-color:#c8f135;} .pg{flex:1;overflow-y:auto;padding:12px 18px 90px;} .pg::-webkit-scrollbar{display:none;} .card{background:#15151e;border:1px solid #1c1c2c;border-radius:13px;padding:13px;margin-bottom:9px;} .ct{font-family:'Bebas Neue',sans-serif;font-size:16px;letter-spacing:1.5px;color:#c8f135;margin-bottom:9px;} .cl{font-size:9px;color:#6a6a8a;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px;margin-top:8px;} .inp{width:100%;background:#111118;border:1px solid #1c1c2c;border-radius:9px;padding:8px 11px;color:#e8e8f0;font-family:'DM Sans',sans-serif;font-size:13px;outline:none;} .inp:focus{border-color:#c8f13544;} .inp::placeholder{color:#3a3a5a;} select.inp option{background:#111118;} .btn{border:none;border-radius:9px;padding:9px 14px;font-family:'DM Sans',sans-serif;font-weight:600;font-size:12px;cursor:pointer;} .btn:active{opacity:.85;} .bacc{background:#c8f135;color:#0a0a0f;} .bgh{background:#1c1c2c;color:#e8e8f0;} .bfull{width:100%;margin-top:9px;} .row{display:flex;gap:7px;} .divider{height:1px;background:#1c1c2c;margin:9px 0;} .sinp{background:#111118;border:1px solid #1c1c2c;border-radius:6px;padding:6px 3px;color:#e8e8f0;font-family:'JetBrains Mono',monospace;font-size:11px;text-align:center;outline:none;width:100%;} .sinp:focus{border-color:#c8f13544;} .srow{display:grid;grid-template-columns:20px 1fr 1fr 26px 22px;gap:4px;align-items:center;margin-bottom:4px;} .snum{font-family:'JetBrains Mono',monospace;font-size:10px;color:#3a3a5a;text-align:center;} .sdone{width:24px;height:24px;border-radius:50%;border:2px solid #1c1c2c;background:transparent;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:11px;} .sdone.ck{background:#c8f135;border-color:#c8f135;color:#0a0a0f;} .chip{display:inline-flex;align-items:center;background:#1c1c2c;border-radius:99px;padding:2px 8px;font-size:9px;color:#6a6a8a;font-weight:500;} .chip.g{background:#c8f13518;color:#c8f135;} .chip.b{background:#4cc9f018;color:#4cc9f0;} .chip.r{background:#ff4d6d18;color:#ff4d6d;} .chip.gold{background:#ffd70018;color:#ffd700;} .aib{background:linear-gradient(135deg,#0d0d1a,#111320);border:1px solid #c8f13530;border-radius:13px;padding:13px;margin-bottom:9px;} .aihdr{display:flex;align-items:center;gap:7px;margin-bottom:9px;} .aidot{width:6px;height:6px;border-radius:50%;background:#c8f135;animation:pulse 1.5s infinite;} @keyframes pulse{0%,100%{opacity:1;}50%{opacity:.3;}} .aitl{font-family:'Bebas Neue',sans-serif;font-size:14px;letter-spacing:1.5px;color:#c8f135;} .aitxt{font-size:11px;color:#6a6a8a;line-height:1.75;} .aitxt b{color:#e8e8f0;} .ldots{display:flex;gap:4px;padding:5px 0;justify-content:center;} .ldot{width:5px;height:5px;border-radius:50%;background:#c8f135;animation:bnc .8s infinite;} .ldot:nth-child(2){animation-delay:.15s;} .ldot:nth-child(3){animation-delay:.3s;} @keyframes bnc{0%,80%,100%{transform:translateY(0);}40%{transform:translateY(-5px);}} .twrap{position:relative;width:120px;height:120px;margin:0 auto 11px;} .tsvg{transform:rotate(-90deg);} .tnum{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-family:'Bebas Neue',sans-serif;font-size:36px;letter-spacing:2px;color:#c8f135;} .tlbl{position:absolute;bottom:12px;left:50%;transform:translateX(-50%);font-size:8px;color:#6a6a8a;letter-spacing:1px;text-transform:uppercase;} .prog{height:4px;background:#1c1c2c;border-radius:99px;overflow:hidden;margin:5px 0;} .progf{height:100%;background:#c8f135;border-radius:99px;transition:width .3s;} .wgr{display:flex;gap:5px;flex-wrap:wrap;margin:7px 0;} .wg{width:30px;height:38px;border:2px solid #1c1c2c;border-radius:3px 3px 6px 6px;cursor:pointer;overflow:hidden;display:flex;align-items:flex-end;} .wg.f{border-color:#4cc9f0;} .wgf{width:100%;background:#4cc9f055;transition:height .3s;} .wg.f .wgf{height:100%;background:#4cc9f0;} .li{background:#111118;border-radius:9px;padding:9px 11px;margin-bottom:5px;border-left:3px solid #c8f13540;} .li.pr{border-left-color:#ffd700;} .li.ss{border-left-color:#4cc9f0;} .lid{font-size:8px;color:#3a3a5a;font-family:'JetBrains Mono',monospace;} .lim{font-weight:600;font-size:12px;margin:2px 0;} .lis{font-size:10px;color:#6a6a8a;} .lin{font-size:9px;color:#3a3a5a;margin-top:2px;font-style:italic;} .prg{display:grid;grid-template-columns:1fr 1fr;gap:7px;} .prc{background:#111118;border-radius:11px;padding:11px;border:1px solid #ffd70030;position:relative;overflow:hidden;} .prc::before{content:'';position:absolute;top:0;right:0;width:32px;height:32px;background:radial-gradient(circle,#ffd70018,transparent);border-radius:0 11px 0 32px;} .pre{font-size:9px;color:#6a6a8a;margin-bottom:2px;} .prw{font-family:'Bebas Neue',sans-serif;font-size:20px;color:#ffd700;} .prd{font-size:9px;color:#3a3a5a;} .prdt{font-size:8px;color:#3a3a5a;font-family:'JetBrains Mono',monospace;margin-top:2px;} .stabs{display:flex;gap:4px;margin-bottom:9px;overflow-x:auto;} .stabs::-webkit-scrollbar{display:none;} .stab{flex-shrink:0;padding:5px 9px;border:1px solid transparent;background:#1c1c2c;color:#6a6a8a;font-family:'DM Sans',sans-serif;font-size:9px;font-weight:600;border-radius:7px;cursor:pointer;} .stab.on{background:#c8f13518;color:#c8f135;border-color:#c8f13540;} .pex{display:flex;justify-content:space-between;align-items:center;padding:4px 0;border-bottom:1px solid #1c1c2c44;} .pex:last-child{border:none;} .pexn{font-size:10px;font-weight:500;flex:1;padding-right:7px;} .pexs{font-size:9px;font-family:'JetBrains Mono',monospace;text-align:right;} .sep{font-size:8px;color:#6a6a8a;text-align:center;padding:4px 0;border-top:1px solid #1c1c2c;margin-top:3px;letter-spacing:1px;} .bnav{position:fixed;bottom:0;left:50%;transform:translateX(-50%);width:100%;max-width:430px;background:#111118;border-top:1px solid #1c1c2c;display:flex;overflow-x:auto;z-index:50;} .bnav::-webkit-scrollbar{display:none;} .bnt{flex-shrink:0;min-width:52px;padding:7px 4px 11px;border:none;background:transparent;color:#3a3a5a;font-size:17px;cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:2px;} .bnt.on{color:#c8f135;} .bnl{font-size:7px;font-weight:600;letter-spacing:.5px;text-transform:uppercase;} .toast{position:fixed;top:14px;left:50%;transform:translateX(-50%);background:#15151e;border:1px solid #c8f13550;border-radius:9px;padding:8px 14px;font-size:11px;font-weight:500;z-index:999;animation:sld .3s ease;max-width:280px;text-align:center;} @keyframes sld{from{opacity:0;transform:translateX(-50%) translateY(-6px);}to{opacity:1;transform:translateX(-50%) translateY(0);}} .mcard{background:#111118;border-radius:9px;padding:9px 11px;border:1px solid #1c1c2c;} .mval{font-family:'Bebas Neue',sans-serif;font-size:20px;line-height:1;margin-bottom:1px;} .mlbl{font-size:8px;color:#6a6a8a;text-transform:uppercase;letter-spacing:.7px;} .mdelta{font-size:9px;margin-top:2px;font-weight:600;} .mgrid{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-bottom:9px;} .sring{position:relative;width:100px;height:100px;margin:0 auto 9px;} .srsvg{transform:rotate(-90deg);} .srnum{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-family:'Bebas Neue',sans-serif;font-size:28px;color:#c8f135;line-height:1;} .srlbl{position:absolute;bottom:10px;left:50%;transform:translateX(-50%);font-size:7px;color:#6a6a8a;letter-spacing:1px;white-space:nowrap;} .srow2{display:flex;justify-content:space-between;align-items:center;padding:5px 0;border-bottom:1px solid #1c1c2c18;} .srow2:last-child{border:none;} .slbl{font-size:10px;color:#6a6a8a;} .sval{font-family:'JetBrains Mono',monospace;font-size:11px;color:#e8e8f0;font-weight:600;} .upz{border:2px dashed #1c1c2c;border-radius:11px;padding:22px;text-align:center;cursor:pointer;background:#111118;} .upz:hover{border-color:#c8f13550;} .upz input{display:none;} .afbtn{width:100%;background:#111118;border:1px solid #1c1c2c;border-radius:11px;padding:11px 13px;display:flex;align-items:center;gap:10px;cursor:pointer;margin-bottom:7px;text-align:left;} .afbtn:active{opacity:.8;} .afbtn.on{border-color:#c8f13540;background:#c8f13505;} .aftl{font-size:12px;font-weight:600;color:#e8e8f0;margin-bottom:1px;} .afsu{font-size:9px;color:#6a6a8a;} .ares{background:#111118;border:1px solid #1c1c2c;border-radius:11px;padding:13px;margin-top:8px;} .aretxt{font-size:11px;color:#6a6a8a;line-height:1.8;white-space:pre-wrap;} .aretxt b{color:#e8e8f0;} .ecard{background:#111118;border-radius:9px;padding:11px;margin-bottom:7px;border:1px solid #1c1c2c;} .edate{font-size:8px;color:#3a3a5a;font-family:'JetBrains Mono',monospace;margin-bottom:5px;} .escore{font-family:'Bebas Neue',sans-serif;font-size:18px;color:#c8f135;} .tbar{display:flex;align-items:flex-end;gap:4px;height:50px;margin-top:7px;} .tcol{flex:1;display:flex;flex-direction:column;align-items:center;gap:2px;} .tseg{width:100%;border-radius:2px;transition:height .3s;} .tv{font-size:6px;color:#3a3a5a;} .mi-grid{display:grid;grid-template-columns:1fr 1fr;gap:7px;} .mi-wrap{display:flex;flex-direction:column;gap:3px;} .mi-lbl{font-size:9px;color:#6a6a8a;letter-spacing:.4px;} .mi-inp{background:#111118;border:1px solid #1c1c2c;border-radius:7px;padding:7px 9px;color:#e8e8f0;font-family:'JetBrains Mono',monospace;font-size:12px;outline:none;width:100%;} .mi-inp:focus{border-color:#c8f13544;} .cal-summary{background:linear-gradient(135deg,#0d1a0d,#111811);border:1px solid #c8f13530;border-radius:13px;padding:13px;margin-bottom:9px;} .cal-ring{display:flex;align-items:center;justify-content:center;gap:16px;margin:8px 0;} .cal-circle{width:80px;height:80px;border-radius:50%;border:4px solid #1c1c2c;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#111118;} .cal-val{font-family:'Bebas Neue',sans-serif;font-size:20px;line-height:1;} .cal-lbl{font-size:7px;color:#6a6a8a;text-transform:uppercase;letter-spacing:.5px;} .cardio-item{background:#111118;border-radius:9px;padding:10px 12px;margin-bottom:6px;border-left:3px solid #4cc9f060;} .mach-wrap{position:relative;} .mach-search{width:100%;background:#111118;border:1px solid #1c1c2c;border-radius:9px;padding:8px 11px 8px 32px;color:#e8e8f0;font-family:'DM Sans',sans-serif;font-size:13px;outline:none;} .mach-search:focus{border-color:#c8f13544;} .mach-search::placeholder{color:#3a3a5a;} .mach-icon{position:absolute;left:10px;top:50%;transform:translateY(-50%);font-size:13px;pointer-events:none;} .mach-dropdown{position:absolute;top:calc(100% + 4px);left:0;right:0;background:#15151e;border:1px solid #c8f13540;border-radius:10px;z-index:100;max-height:220px;overflow-y:auto;box-shadow:0 8px 24px #00000080;} .mach-dropdown::-webkit-scrollbar{width:4px;} .mach-dropdown::-webkit-scrollbar-thumb{background:#1c1c2c;border-radius:4px;} .mach-opt{padding:9px 12px;font-size:12px;color:#e8e8f0;cursor:pointer;border-bottom:1px solid #1c1c2c22;display:flex;align-items:center;justify-content:space-between;} .mach-opt:last-child{border-bottom:none;} .mach-opt:hover{background:#c8f13512;} .mach-opt.selected{background:#c8f13518;color:#c8f135;} .mach-opt.add-new{color:#c8f135;font-style:italic;} .mach-none{padding:12px;font-size:11px;color:#6a6a8a;text-align:center;} .cam-modal{position:fixed;top:0;left:0;right:0;bottom:0;background:#000000ee;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:20px;} .cam-box{background:#15151e;border-radius:18px;width:100%;max-width:390px;overflow:hidden;border:1px solid #1c1c2c;} .cam-header{padding:14px 16px;border-bottom:1px solid #1c1c2c;display:flex;align-items:center;justify-content:space-between;} .cam-title{font-family:'Bebas Neue',sans-serif;font-size:18px;letter-spacing:1.5px;color:#c8f135;} .cam-close{background:none;border:none;color:#6a6a8a;font-size:22px;cursor:pointer;line-height:1;} .cam-body{padding:16px;} .cam-preview{width:100%;border-radius:12px;overflow:hidden;background:#111118;margin-bottom:12px;min-height:160px;display:flex;align-items:center;justify-content:center;} .cam-preview img{width:100%;border-radius:12px;display:block;} .cam-trigger{width:100%;border:2px dashed #1c1c2c;border-radius:12px;padding:28px;text-align:center;cursor:pointer;background:#111118;margin-bottom:12px;} .cam-trigger:hover{border-color:#c8f13550;} .cam-trigger input{display:none;} .cam-result{background:#111118;border-radius:10px;padding:12px;margin-bottom:12px;border:1px solid #1c1c2c;} .cam-conf-high{color:#c8f135;} .cam-conf-med{color:#ff9f1c;} .cam-conf-low{color:#ff4d6d;}`;
...
```
    ...
    <div className="htop">
      ...
      <div className="hbtns">
        <button className="icb" style={{position:"relative"}} onClick={()=>setWaterOpen(v=>!v)}>
          💧
          <span style={{position:"absolute",top:-2,right:-2,background:waterMl>=waterGoal?"#c8f135":"#4cc9f0",color:"#0a0a0f",borderRadius:"50%",minWidth:14,height:14,padding:"0 2px",fontSize:7,fontWeight:700,display:"flex",alignItems:"center",justifyContent:"center",lineHeight:1,whiteSpace:"nowrap"}}>
  ...
  {waterOpen && (
    <div style={{background:"#15151e",borderBottom:"1px solid #1c1c2c",padding:"12px 18px"}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
        <div style={{fontSize:12,fontWeight:600,color:"#e8e8f0"}}>💧 Hydration Today</div>
        <div style={{display:"flex",alignItems:"center",gap:6}}>
          <span style={{fontFamily:"'JetBrains Mono',monospace",fontSize:12,color:waterMl>=waterGoal?"#c8f135":"#4cc9f0",fontWeight:700}}>
            {waterMl>=1000?(waterMl/1000).toFixed(2)+"L":waterMl+"ml"}
          </span>
          <span style={{fontSize:10,color:"#6a6a8a"}}>/ {waterGoal>=1000?(waterGoal/1000)+"L":waterGoal+"ml"}</span>
          <span style={{fontSize:9,color:waterMl>=waterGoal?"#c8f135":waterMl>=waterGoal*0.6?"#4cc9f0":"#ff4d6d",background:waterMl>=waterGoal?"#c8f13518":waterMl>=waterGoal*0.6?"#4cc9f018":"#ff4d6d18",padding:"2px 7px",borderRadius:99,fontWeight:600}}>
      ...
      {/* Quick add buttons */}
      <div style={{fontSize:9,color:"#6a6a8a",textTransform:"uppercase",letterSpacing:1,marginBottom:6}}>Quick Add</div>
      <div style={{display:"flex",gap:6,marginBottom:10}}>
        {[150,250,350,500,750,1000].map(ml=>(
          <button key={ml} onClick={()=>{setWaterMl(w=>w+ml);showToast("+" + ml + "ml logged!");}}
            style={{flex:1,padding:"7px 2px",background:"#111118",border:"1px solid #1c1c2c",borderRadius:8,color:ml>=500?"#c8f135":"#4cc9f0",fontSize:9,fontWeight:600,cursor:"pointer",lineHeight:1.3,textAlign:"center"}}>
            <div style={{fontSize:11}}>{ml>=1000?(ml/1000)+"L":ml}</div>
            <div style={{fontSize:7,color:"#6a6a8a"}}>{ml>=1000?"litre":"ml"}</div>
          </button>
        ))}
      </div>
      {/* Custom amount */}
      <div style={{fontSize:9,color:"#6a6a8a",textTransform:"uppercase",letterSpacing:1,marginBottom:6}}>Custom Amount (ml)</div>
      <div style={{display:"flex",gap:7,marginBottom:10}}>
        ...
        <button className="btn bacc" style={{padding:"7px 14px",fontSize:12}} onClick={()=>{
      ...
      {/* Goal setting */}
      <div style={{fontSize:9,color:"#6a6a8a",textTransform:"uppercase",letterSpacing:1,marginBottom:6}}>Daily Goal</div>
      <div style={{display:"flex",gap:5,marginBottom:10}}>
        {[2000,2500,3000,3500,4000].map(g=>(
          <button key={g} onClick={()=>{setWaterGoal(g);showToast("Goal set to "+(g/1000)+"L");}}
            style={{flex:1,padding:"5px 2px",background:waterGoal===g?"#c8f13518":"#111118",border:"1px solid "+(waterGoal===g?"#c8f13540":"#1c1c2c"),borderRadius:7,color:waterGoal===g?"#c8f135":"#6a6a8a",fontSize:9,fontWeight:600,cursor:"pointer"}}>
            {g/1000}L
          </button>
        ))}
      </div>
      ...
      <div style={{display:"flex",gap:7}}>
        <button className="btn bgh" style={{flex:1,fontSize:11}} onClick={()=>{setWaterMl(0);showToast("Water reset for today");}}>
          Reset Today
        </button>
        <button className="btn bgh" style={{padding:"9px 14px",fontSize:12}} onClick={()=>setWaterOpen(false)}>✕</button>
      </div>
    </div>
  )}
      ...
      <>
        <div className="aib">
          ...
          {(liveCalEst || liveCalLoading) && (
            <div style={{marginTop:8,background:"#0d1a0d",borderRadius:8,padding:"7px 10px",fontSize:10,color:liveCalLoading?C.sub:C.grn,display:"flex",alignItems:"center",gap:6}}>
        ...
        {(savedPlans.length > 0 || PLANS.length > 0) && (
          <div className="card" style={{padding:"11px 13px"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:selectedSessionPlan?8:0}}>
              <div style={{fontSize:11,fontWeight:600,color:C.txt}}>📋 Today's Plan</div>
              <button onClick={()=>setPlanSelectOpen(v=>!v)}
                style={{background:selectedSessionPlan?"#c8f13518":C.bdr,border:"1px solid "+(selectedSessionPlan?"#c8f13540":C.bdr),borderRadius:7,padding:"4px 10px",fontSize:10,color:selectedSessionPlan?C.acc:C.sub,cursor:"pointer",fontWeight:600}}>
                {selectedSessionPlan ? selectedSessionPlan.name : "Select Plan"}
              </button>
            </div>
            {planSelectOpen && (
              <div style={{background:C.sur,borderRadius:9,padding:8,marginTop:7}}>
                <div style={{fontSize:9,color:C.sub,marginBottom:6,textTransform:"uppercase",letterSpacing:1}}>Built-in Plans</div>
                {PLANS.map((p,i)=>(
                  <div key={p.id} onClick={()=>{setSelectedSessionPlan({...p,type:"builtin",idx:i});setPlanSelectOpen(false);}}
                    ...
                    <span style={{fontSize:11,fontWeight:600,color:p.color}}>{p.day}</span>
                    <span style={{fontSize:10,color:C.txt,marginLeft:7}}>{p.name}</span>
                  </div>
                ))}
                {savedPlans.length > 0 && <>
                  <div style={{fontSize:9,color:C.sub,marginBottom:6,marginTop:9,textTransform:"uppercase",letterSpacing:1}}>Saved Plans</div>
                  {savedPlans.map(p=>(
                    <div key={p.id} onClick={()=>{setSelectedSessionPlan({...p,type:"saved"});setPlanSelectOpen(false);}}
                      style={{padding:"7px 9px",borderRadius:7,cursor:"pointer",marginBottom:3,background:selectedSessionPlan?.id===p.id?"#c8f13512":C.card,border:"1px solid "+(selectedSessionPlan?.id===p.id?"#c8f13540":C.bdr)}}>
                      <span style={{fontSize:10,fontWeight:600,color:C.pur}}>{p.name}</span>
                    </div>
                  ))}
                </>}
                <button className="btn bgh bfull" style={{marginTop:6,fontSize:10}} onClick={()=>{setSelectedSessionPlan(null);setPlanSelectOpen(false);}}>Clear Selection</button>
              </div>
            )}
            {selectedSessionPlan && !planSelectOpen && (
              <div style={{marginTop:4}}>
                <div style={{fontSize:9,color:C.sub,marginBottom:5}}>Tap an exercise to pre-fill the machine:</div>
                <div style={{display:"flex",flexWrap:"wrap",gap:4}}>
                  {(selectedSessionPlan.type==="builtin" ? selectedSessionPlan.exercises : (selectedSessionPlan.days?.[0]?.exercises||[]))
                    ...
                    .map((ex,i)=>(
                      ...
                      style={{background:C.bdr,border:"none",borderRadius:6,padding:"4px 8px",fontSize:9,color:C.txt,cursor:"pointer",fontWeight:500}}>
            ...
            <div className="cal-summary">
              ...
              {aiCalEst && (
                <div style={{marginTop:10,fontSize:11,color:C.sub,lineHeight:1.8,whiteSpace:"pre-wrap"}}
                  dangerouslySetInnerHTML={{__html:(aiCalEst||"").split("\n").join("<br/>").replace(/\*\*(.*?)\*\*/g,"<b>$1</b>")}}/>
              )}
            </div>
          ) : null;
        })()}
    ...
    {tab==="plan" && !editingPlan && (
      <>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:3}}>
          ...
          <button className="btn bacc" style={{fontSize:10,padding:"5px 11px"}} onClick={()=>{
        ...
        <div style={{fontSize:9,color:C.sub,marginBottom:9}}>Built-in + your saved plans</div>

        {/* Built-in plans */}
        <div style={{fontSize:9,color:C.sub,textTransform:"uppercase",letterSpacing:1,marginBottom:6}}>Built-in Programme (Jun–Jul 2025)</div>
        ...
        {/* Saved plans */}
        {savedPlans.length > 0 && <>
          <div style={{fontSize:9,color:C.sub,textTransform:"uppercase",letterSpacing:1,marginBottom:6}}>Your Saved Plans ({savedPlans.length})</div>
          {savedPlans.map((plan,pi)=>(
            <div key={plan.id} className="card" style={{marginBottom:9}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:15,letterSpacing:1.5,color:plan.color||C.pur}}>{plan.name}</div>
                <div style={{display:"flex",gap:5}}>
                  <button className="btn bgh" style={{fontSize:10,padding:"4px 9px"}} onClick={()=>{setEditPlanData({...plan});setEditingPlan(true);}}>Edit</button>
                  <button style={{background:"#ff4d6d18",border:"1px solid #ff4d6d40",borderRadius:7,padding:"4px 9px",fontSize:10,color:C.red,cursor:"pointer"}}
                    onClick={()=>{if(window.confirm("Delete this plan?")){savePlansToStorage(savedPlans.filter((_,i)=>i!==pi));}}}>Del</button>
                </div>
              </div>
              {plan.rawText ? (
                <div style={{fontSize:10,color:C.sub,lineHeight:1.7,whiteSpace:"pre-wrap"}}
                ...
                plan.days?.map((day,di)=>(
                  day.exercises?.filter(ex=>ex.name).length > 0 && (
                    <div key={di} style={{marginBottom:7}}>
                      <div style={{fontSize:9,color:plan.color||C.acc,fontWeight:700,marginBottom:4,textTransform:"uppercase",letterSpacing:1}}>{day.day} — {day.name}</div>
                      {day.exercises.filter(ex=>ex.name).map((ex,ei)=>(
                        <div key={ei} className="pex">
                          <div className="pexn">{ex.name}</div>
                          <div style={{textAlign:"right",flexShrink:0}}>
                            <div style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace",color:plan.color||C.acc}}>{ex.sets}</div>
                            <div style={{fontSize:8,color:C.mut}}>{ex.weight}</div>
                          </div>
                        </div>
                      ))}
        ...
        {savedPlans.length === 0 && (
          <div style={{textAlign:"center",padding:"18px 0",color:C.mut,fontSize:11}}>
      ...
      <>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:11}}>
          ...
          <div style={{display:"flex",gap:6}}>
            ...
            <button className="btn bgh" style={{fontSize:10,padding:"5px 11px"}} onClick={()=>{setEditingPlan(false);setEditPlanData(null);}}>Cancel</button>
          </div>
        </div>
        ...
        {editPlanData.rawText ? (
          <div className="card">
            ...
            <div style={{fontSize:10,color:C.sub,lineHeight:1.7,whiteSpace:"pre-wrap",marginBottom:9}}
              dangerouslySetInnerHTML={{__html:(editPlanData.rawText||"").split("\n").join("<br/>")}}/>
            <button className="btn bgh bfull" style={{fontSize:10}} onClick={()=>setEditPlanData(p=>({...p,rawText:"",days:["Mon","Tue","Wed","Thu","Fri","Sat","Sun"].map((d,i)=>({day:d,name:"Day "+(i+1),exercises:[{name:"",sets:"",weight:""}]}))}))}>
          ...
          editPlanData.days?.map((day, di)=>(
            <div key={di} className="card">
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:14,letterSpacing:1,color:C.acc}}>{day.day}</div>
                <input className="inp" style={{width:160,fontSize:11,padding:"4px 8px"}} value={day.name}
              ...
              <button className="btn bgh bfull" style={{fontSize:10,marginTop:4}}
        ...
        {bodyTab==="water" && (
          <div className="card">
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
              <span style={{fontFamily:"'JetBrains Mono',monospace",fontSize:18,fontWeight:700,color:waterMl>=waterGoal?"#c8f135":"#4cc9f0"}}>
                {waterMl>=1000?(waterMl/1000).toFixed(2)+"L":waterMl+"ml"}
              </span>
              <span style={{fontSize:11,color:"#6a6a8a"}}>goal: {waterGoal/1000}L</span>
            </div>
            ...
            <div style={{fontSize:10,color:"#6a6a8a",marginBottom:10,marginTop:4}}>{Math.round(waterMl/waterGoal*100)}% of daily goal · {Math.max(waterGoal-waterMl,0)}ml remaining</div>
            <div style={{fontSize:9,color:"#6a6a8a",textTransform:"uppercase",letterSpacing:1,marginBottom:6}}>Quick Add</div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:6,marginBottom:10}}>
              {[150,250,350,500,750,1000].map(ml=>(
                <button key={ml} onClick={()=>{setWaterMl(w=>w+ml);showToast("+"+ml+"ml");}}
                  ...
                  <div style={{fontSize:14,fontWeight:700,fontFamily:"'JetBrains Mono',monospace"}}>{ml>=1000?ml/1000+"L":ml}</div>
                  <div style={{fontSize:8,color:"#6a6a8a"}}>{ml>=1000?"litre":"ml"}</div>
                </button>
              ))}
            </div>
            <div style={{display:"flex",gap:7,marginBottom:10}}>
            ...
            {latest?.bmr>0 && (
              <div style={{background:"#111118",borderRadius:9,padding:"9px 11px",fontSize:10,color:"#6a6a8a",lineHeight:1.6}}>
            ...
            <button className="btn bgh bfull" style={{marginTop:8,fontSize:11}} onClick={()=>{setWaterMl(0);showToast("Reset!");}}>Reset Today</button>
          </div>
        )}
  ...
  <div className="bnav">
    {[["workout","🏋️","Log"],["cardio","🏃","Cardio"],["ai","🤖","AI"],["plan","📋","Plan"],["records","🏆","PRs"],["history","📊","Hist"],["body","🧬","Body"],["settings","⚙️","Setup"]].map(([k,ic,lb])=>(
